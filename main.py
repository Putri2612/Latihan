...
if selected == 'Dashboard':
    ...
    st.write("Akurasi dari sistem ini adalah 94.13%")
...
if selected == 'Report':
    ...
    report_data = {
        "RF": {
            "accuracy": 0.94,
            "precision": [0.89, 0.96, 0.92],
            "recall": [0.96, 0.90, 0.98],
            "f1_score": [0.92, 0.93, 0.98],
            "processing_time": 235.89,
        },
        "RF+IG 0,02": {
            "accuracy": 0.91,
            "precision": [0.87, 0.90, 0.99],
            "recall": [0.89, 0.88, 0.97],
            "f1_score": [0.88, 0.89, 0.98],
            "processing_time": 114.32,
        },
        "RF+IG 0,002": {
            "accuracy": 0.93,
            ...
            "processing_time": 148.89,
        },
        "RF+IG 0,004": {
            "accuracy": 0.94,
            "precision": [0.89, 0.96, 0.99],
            "recall": [0.95, 0.89, 0.99],
            "f1_score": [0.92, 0.92, 0.99],
            "processing_time": 132.43,
        },
        "RF+IG 0,006": {
            "accuracy": 0.93,
            "precision": [0.89, 0.91, 0.99],
            "recall": [0.91, 0.89, 0.99],
            "f1_score": [0.90, 0.90, 0.99],
            "processing_time": 131.63,
        },
    }
    ...
    with tab1:
        ...
        accuracies = [0.94, 0.91, 0.93, 0.94, 0.93]
        ...
        plt.figure(figsize=(10, 6))
        plt.plot(["RF", "RF+IG 0,02", "RF+IG 0,002", "RF+IG 0,004", "RF+IG 0,006"], [235.89, 114.32, 148.89, 132.43, 131.63], marker='o', label='Waktu Proses (detik)', color='orange')
        plt.xlabel("Model")
        ...
        for x, y in zip(["RF", "RF+IG 0,02", "RF+IG 0,002", "RF+IG 0,004", "RF+IG 0,006"], [235.89, 114.32, 148.89, 132.43, 131.63]):
